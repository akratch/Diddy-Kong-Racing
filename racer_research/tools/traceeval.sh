#!/bin/bash
# Like isoeval.sh but uses the /tmp/codex-ido-trace toolchain (env-gated trace ugen).
# Trace: CODEX_UGEN_TRACE=1  Rot-hack: CODEX_UGEN_ROT=1  (unset = stock behavior)
SP=/private/tmp/claude-501/-Users-adamkratch-Desktop-dev-Diddy-Kong-Racing/17d442b1-2bf9-4288-bd1d-f3fe212e89a1/scratchpad
cd $SP/work-racer
/tmp/codex-ido-trace/cc -c -G 0 -non_shared -Xcpluscomm -nostdinc -Wab,-r4300_mul \
 ...
 -woff 838,649,624,835,516,550 -O2 -mips1 -o "$2" "$1"
